...
<section class="gsap py-16 bg-gray-50">
  <div class="max-w-full px-6 lg:px-20">
    ...
    <p class="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
      Hear from students who made Europe their education destination
    </p>
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          ...
          <div class="ml-4">
            ...
            <p class="text-purple-600 text-sm">Technical University of Munich</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"Studying in Germany with no tuition fees allowed me to focus on my mechanical engineering degree without financial stress."</p>
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          ...
          <div class="ml-4">
            ...
            <p class="text-purple-600 text-sm">Sorbonne University, France</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The affordable tuition in France combined with Paris's vibrant culture made my international business degree unforgettable."</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          ...
          <div class="ml-4">
            ...
            <p class="text-purple-600 text-sm">Delft University, Netherlands</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The orientation year visa after graduation helped me find my dream job at a Dutch tech company."</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
