    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-red-600 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/5a/University_of_Tokyo_logo.svg/1200px-University_of_Tokyo_logo.svg.png" alt="University of Tokyo" class="h-24 object-contain">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-blue-800 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/Kyoto_University_logo.svg/1200px-Kyoto_University_logo.svg.png" alt="Kyoto University" class="h-24 object-contain">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-gray-800 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/1/15/Tokyo_Institute_of_Technology_logo.svg/1200px-Tokyo_Institute_of_Technology_logo.svg.png" alt="Tokyo Institute of Technology" class="h-24 object-contain">
        </div>
        <div class="p-6">
...
<section id="consultation" class="gsap py-20 bg-gradient-to-br from-purple-900 to-indigo-800 text-white">
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-4">
      ...
      <a href="tel:9852082384" class="inline-flex items-center justify-center bg-transparent hover:bg-white/10 border-2 border-white text-white font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300">
...
<section class="gsap py-16 bg-gray-50">
  <div class="max-w-full px-6 lg:px-20">
    <h2 class="text-3xl md:text-4xl font-bold text-center mb-4">
      Student <span class="text-purple-600">Experiences</span>
    </h2>
    <p class="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
      Hear from students who studied in Japan
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          <img class="w-12 h-12 rounded-full object-cover" src="https://randomuser.me/api/portraits/women/32.jpg" alt="Aarati">
          <div class="ml-4">
            <h4 class="font-bold">Aarati M.</h4>
            <p class="text-purple-600 text-sm">Tokyo University of Science</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The robotics program exceeded my expectations. I got internship offers from two major tech companies during my second year."</p>
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          <img class="w-12 h-12 rounded-full object-cover" src="https://randomuser.me/api/portraits/men/45.jpg" alt="Rajesh">
          <div class="ml-4">
            <h4 class="font-bold">Rajesh K.</h4>
            <p class="text-purple-600 text-sm">Yokohama National University</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The language school prepared me well for university. Now I'm fluent in Japanese and have a job at a major trading company."</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
      ...
      <div class="bg-white p-8 rounded-xl shadow-md">
        <div class="flex items-center mb-6">
          <img class="w-12 h-12 rounded-full object-cover" src="https://randomuser.me/api/portraits/women/55.jpg" alt="Sakshi">
          <div class="ml-4">
            <h4 class="font-bold">Sakshi P.</h4>
            <p class="text-purple-600 text-sm">Osaka University</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"Living in Japan transformed me. The work ethic and attention to detail I learned here helped me start my own design business back home."</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
