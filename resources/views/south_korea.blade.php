    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-blue-900 flex items-center justify-center">
          <img src="https://en.snu.ac.kr/webdata/uploads/eng/image/2020/02/index-campas-img01.jpg" alt="Seoul National University" class="h-full w-full object-cover">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-red-900 flex items-center justify-center">
          <img src="https://www.shutterstock.com/image-photo/yuseonggu-daejeon-south-korea-april-260nw-1778931371.jpg" alt="KAIST" class="h-full w-full object-cover">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-yellow-700 flex items-center justify-center">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgyB7px2sr1fztu6wS9h3xVJvU0VnWpwjIBw&s" alt="Yonsei University" class="h-full w-full object-cover">
        </div>
        <div class="p-6">
