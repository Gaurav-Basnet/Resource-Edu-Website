  ...
  <div class="max-w-full px-6 lg:px-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition duration-300 border border-gray-100 hover:border-purple-200">
        ...
        <p class="text-gray-600">Australian degrees are recognized worldwide with 7 universities in the top 100 globally.</p>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-blue-900 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/6/6a/University_of_Melbourne_coat_of_arms.svg/1200px-University_of_Melbourne_coat_of_arms.svg.png" alt="University of Melbourne" class="h-24 object-contain">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-red-800 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/6/6a/Australian_National_University_logo.svg/1200px-Australian_National_University_logo.svg.png" alt="Australian National University" class="h-24 object-contain">
        </div>
        <div class="p-6">
      ...
      <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition duration-300">
        <div class="h-48 bg-yellow-600 flex items-center justify-center">
          <img src="https://upload.wikimedia.org/wikipedia/en/thumb/6/6a/University_of_Sydney_Logo.svg/1200px-University_of_Sydney_Logo.svg.png" alt="University of Sydney" class="h-24 object-contain">
        </div>
        <div class="p-6">
...
<section class="gsap  py-16 bg-white">
  <div class="max-w-full px-6 lg:px-20">
    ...
    <p class="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
      Hear from students who achieved their Australian education dreams
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-gray-50 p-8 rounded-xl">
        <div class="flex items-center mb-6">
          ...
          <div class="ml-4">
            ...
            <p class="text-purple-600 text-sm">University of Sydney</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The guidance I received was invaluable. From choosing the right course to navigating the visa process, everything was handled professionally."</p>
      ...
      <div class="bg-gray-50 p-8 rounded-xl">
        <div class="flex items-center mb-6">
          <img class="w-12 h-12 rounded-full object-cover" src="https://randomuser.me/api/portraits/men/32.jpg" alt="Raj">
          <div class="ml-4">
            <h4 class="font-bold">Raj P.</h4>
            <p class="text-purple-600 text-sm">Monash University</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"I got accepted into my dream university with a scholarship! The team helped me prepare a strong application that stood out."</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
      ...
      <div class="bg-gray-50 p-8 rounded-xl">
        <div class="flex items-center mb-6">
          <img class="w-12 h-12 rounded-full object-cover" src="https://randomuser.me/api/portraits/women/65.jpg" alt="Priya">
          <div class="ml-4">
            <h4 class="font-bold">Priya M.</h4>
            <p class="text-purple-600 text-sm">University of Queensland</p>
          </div>
        </div>
        <p class="text-gray-600 italic mb-4">"The visa process seemed daunting, but my counselor walked me through each step. I got my visa in just 6 weeks!"</p>
        <div class="flex text-yellow-400">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
          </svg>
