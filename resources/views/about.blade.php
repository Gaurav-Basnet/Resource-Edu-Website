...
@section('content')
  ...
  <section
    class="gsap relative bg-gradient-to-br from-purple-800 to-indigo-700 h-10 min-h-[300px] md:min-h-[350px] overflow-hidden">
    ...
    <div class="container mx-auto px-6 text-center py-10">
      ...
      <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-white">Pioneering</span> Your
  ...
  <div id="about" class="gsap relative w-full py-12 px-6 lg:px-20 bg-white">
    ...
    <div class="grid md:grid-cols-2 gap-8 items-start">
      ...
      <p class="text-lg text-gray-700 mb-2 leading-relaxed text-justify">
        ...
        is a dedicated and dynamic educational consultancy based in Nepal, committed to helping students achieve their
        dreams of studying abroad. We specialize in providing professional, ethical, and student-focused services that
        guide individuals toward the best educational opportunities around the globe.
      </p>

      <div>
        <p class="text-lg text-gray-700 mb-2 leading-relaxed text-justify font-roboto font-small">
        Our journey began with a clear vision to become a trusted resource center for students aspiring for
        international education. With a team of experienced counselors and and a wide network of of partner
        institutions across countries like Australia, Canada, the UK, USA, South Korea, Europe, Japan, and more, we
        offer end-to-end support throughout your study abroad journey.


        </p>
      </div>

      <p id="expandable-content" class="hidden" >
       <span class="text-lg text-gray-700 mb-6 leading-relaxed text-justify "> From career counseling, university selection, documentation assistance, and language test preparation (IELTS,
        PTE, etc.), to application processing and visa guidance - we provide a one-stop solution under one roof.
        approach is transparent, personalized, and based on real-time updates from the global education market. Our
        ist
        At Resource, we believe education is not just about degrees, but about transforming lives. Our aim is to
        ensure every student who walks through our doors receives honest guidance, timely information, and unwavering
        support to reach their destination with confidence.
        Join hands with us - and let your journey to global success begin with Resource Education Hub.</span>
      </p>
      ...
      <div class="relative h-full w-full overflow-hidden">
        ...
        <div class="min-w-full h-full relative flex-shrink-0">
          <img src="../assests/images/about.jpg" alt="Resource Education Hub team helping students"
        ...
        <div class="min-w-full h-full relative flex-shrink-0">
          ...
          <p class="text-white text-xs sm:text-sm font-medium font-roboto">
           ...
           <!-- Slide 3 -->
        <div class="min-w-full h-full relative flex-shrink-0">
          <img src="../assests/images/carrer.png" alt="University admission process"
          class="w-full h-full object-cover object-center overflow-hidden" loading="lazy" />
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3 sm:p-4">
          <p class="text-white text-xs sm:text-sm font-medium font-roboto">
  ...
  <section class="gsap py-16 bg-gradient-to-br from-purple-50 to-white">
    ...
    <div class="grid gap-10 md:grid-cols-2">
      <!-- Vision Card -->
      <div
      class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition duration-500 transform hover:-translate-y-2 border-l-4 border-purple-500">
      ...
      <p class="text-gray-700 text-lg font-roboto leading-relaxed">
        "To become a global leader in accessible education, empowering learners of all ages with the knowledge and
        skills needed to thrive in an ever-evolving world."
      </p>
      </div>
      ...
      <p class="text-gray-700 text-lg font-roboto leading-relaxed">
        "To provide high-quality, innovative, and inclusive educational resources that inspire lifelong learning,
        bridge knowledge gaps, and foster personal and professional growth for individuals and communities worldwide."
      </p>
      </div>
    </div>
  ...
  <div class="gsap py-16 bg-gray-50">
    ...
    <div class="text-center">
      ...
      <p class="text-lg text-gray-600 max-w-3xl mx-auto">We're committed to providing the best learning resources with
      these key advantages</p>
    </div>
    ...
    <div class="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">Access to thousands of high-quality educational materials across all subjects
          and levels.</p>
        </div>
      </div>
      </div>
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">All resources are carefully selected and reviewed by subject matter experts.
        </p>
        </div>
      </div>
      </div>
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">24/7 availability from any device, with offline options for remote learning.
        </p>
        </div>
      </div>
      </div>
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">Adaptive tools that customize content based on your learning style and
          progress.</p>
        </div>
      </div>
      </div>
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">Premium educational resources at a fraction of traditional education costs.
        </p>
        </div>
      </div>
      </div>
      ...
      <div class="flex items-start">
        ...
        <p class="mt-2 text-gray-600">Connect with educators and learners worldwide through our interactive
          platform.</p>
        </div>
      </div>
      </div>
  ...
  <section id="uni" class="gsap universities">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      class="hidden col-span-1 sm:col-span-2 lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <!-- Card 4 -->
      <div class="relative group overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
        <a href="#">
        <img class="w-full h-64 object-cover transition-all duration-500 group-hover:scale-105"
          src="https://image-static.collegedunia.com/public/college_data/images/studyabroad/appImage/college_1090_29-15:00_o-HARVARD-UNIVERSITY-BUILDING-facebook.jpeg" alt="USA">
        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
        <figcaption class="absolute bottom-0 left-0 right-0 p-4 text-white">
      ...
      <div class="relative group overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
        <a href="#">
        <img class="w-full h-64 object-cover transition-all duration-500 group-hover:scale-105"
          src="https://www.ox.ac.uk/sites/files/oxford/styles/ow_large_feature/s3/field/field_image_main/b_AllSoulsquad.jpg?itok=tTcH-5ix" alt="UK">
        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
        <figcaption class="absolute bottom-0 left-0 right-0 p-4 text-white">
      ...
      <div class="relative group overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
        <a href="#">
        <img class="w-full h-64 object-cover transition-all duration-500 group-hover:scale-105"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmavPZ1QAt7q4epCKQTAeL5URIBGOMw0PJ7Q&s" alt="Canada">
        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
        <figcaption class="absolute bottom-0 left-0 right-0 p-4 text-white">
  ...
  <section class="gsap py-16 px-6 md:px-16 relative overflow-hidden">
    ...
    <p class="text-gray-600 text-lg font-roboto max-w-xl mx-auto">The dedicated professionals behind Resource Education
      Hub</p>
    </div>
    ...
    <div class="team-scroll-container overflow-x-auto pb-8 -mx-6 px-6">
      ...
      <div
        class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 text-center transform hover:-translate-y-2 group">
        <div
        class="relative w-32 h-32 mx-auto mb-4 overflow-hidden rounded-full border-4 border-purple-100 group-hover:border-purple-300 transition-all">
        <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
        src="{{ $teammember->image ? asset('storage/' . $teammember->image) : 'https://via.placeholder.com/150' }}"
        alt="{{ $teammember->name }}">
        </div>
        <h3 class="text-xl font-semibold font-roboto text-purple-700">{{ $teammember->name }}</h3>
        <p class="text-gray-500 font-roboto text-sm mb-3">{{ $teammember->position }}</p>
        <p class="text-gray-600 font-roboto text-sm mb-4">{{ $teammember->bio }}</p>
        <div class="flex justify-center space-x-3">
        @if($teammember->facebook)
      <a href="{{ $teammember->facebook }}" class="text-purple-500 hover:text-purple-700 transition"><i
        class="fab fa-facebook"></i></a>
      @endif
        @if($teammember->instagram)
      <a href="{{ $teammember->instagram }}" class="text-purple-500 hover:text-purple-700 transition"><i
        class="fab fa-instagram"></i></a>
      @endif
        @if($teammember->email)
      <a href="mailto:{{ $teammember->email }}" class="text-purple-500 hover:text-purple-700 transition"><i
    ...
    <button
      class="team-scroll-left bg-purple-100 text-purple-700 w-10 h-10 rounded-full flex items-center justify-center hover:bg-purple-200 transition">
      <i class="fas fa-chevron-left"></i>
    </button>
    <button
      class="team-scroll-right bg-purple-100 text-purple-700 w-10 h-10 rounded-full flex items-center justify-center hover:bg-purple-200 transition">
  ...
  <section class="gsap bg-gray-100 py-12">
    ...
    <div class="flex flex-wrap justify-center items-center gap-8">
      <!-- Logo 1 -->
      <img src="https://1000logos.net/wp-content/uploads/2021/03/IELTS-logo.png" alt="IELTS Logo"
      class="h-16  transition duration-300" />

      <!-- Logo 2 -->
      <img src="https://www.pngitem.com/pimgs/m/399-3990213_pearson-pte-academic-logo-hd-png-download.png"
      alt="PTE Academic Logo" class="h-16  transition duration-300" />

      <!-- Logo 3 -->
      <img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Japanese-Language_Proficiency_Test_logo.svg"
      alt="JLPT Logo" class="h-16 0 transition duration-300" />

      <!-- Logo 4 -->
      <img src="https://media.edusanjal.com/__sized__/logos/british-council-logo-thumbnail-200x200.png"
      alt="ISO 9001 Certification" class="h-16  transition duration-300" />
